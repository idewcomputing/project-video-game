...
1. **Create a paper prototype that can be used to demonstrate your core gameplay.**
   ...
   * Many games display certain gameplay information \(such as: score, etc.\). Determine if there is certain information \(such as: health, etc.\) that will be important to show in your prototype for playtesting.
